...
export const AddNewCatDocument = gql`
  ...
  add(newCat: $newCat) {
    ...
    `;
export type AddNewCatMutationFn = Apollo.MutationFunction<AddNewCatMutation, AddNewCatMutationVariables>;
 ...
 * });
 */
export function useAddNewCatMutation(baseOptions?: Apollo.MutationHookOptions<AddNewCatMutation, AddNewCatMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddNewCatMutation, AddNewCatMutationVariables>(AddNewCatDocument, options);
      }
export type AddNewCatMutationHookResult = ReturnType<typeof useAddNewCatMutation>;
export type AddNewCatMutationResult = Apollo.MutationResult<AddNewCatMutation>;
export type AddNewCatMutationOptions = Apollo.BaseMutationOptions<AddNewCatMutation, AddNewCatMutationVariables>;